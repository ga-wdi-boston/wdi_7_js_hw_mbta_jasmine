...
describe('Line constructor function',function(){
  ...
  it('creates a new object with the parameters passed',function(){
    var green = new Line('green', ["Haymarket", "Government Center", "Park St", "Boylston", "Arlington", "Copley"]);
    expect(green).toBeDefined();
    expect(green.name).toEqual('green');
    expect(green.stops).toEqual(["Haymarket", "Government Center", "Park St", "Boylston", "Arlington", "Copley"]);
  });
});

describe('Line object methods', function(){
  // it('is a function',function(){
  //   expect(distanceToPark).toEqual(jasmine.any(Function));
  //   expect(distanceToPark).toBeDefined();
  // });

  it('has a `distanceToPark` property with a value of a function that takes a stop parameter and returns the distance from the stop to Park Street',function(){
    // spyOn(Line, 'distanceToPark').and.callThrough();
    expect(Line.distanceToPark).toEqual(jasmine.any(Function));
